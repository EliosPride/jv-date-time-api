...
public class JavaDateTimeApiTest {
    ...
    @Test
    public void toDateYEAR() {
        String expected = String.valueOf(LocalDate.now().getYear());
        String result = javaDateTimeApi.todayDate(DateTimePart.YEAR);
        Assert.assertEquals(expected, result);
    }

    @Test
    public void toDateMONTH() {
        String expected = String.valueOf(LocalDate.now().getMonth());
        String result = javaDateTimeApi.todayDate(DateTimePart.MONTH);
        Assert.assertEquals(expected, result);
    }

    @Test
    public void toDateDAY() {
        String expected = String.valueOf(LocalDate.now().getDayOfMonth());
